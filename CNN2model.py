# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 16:15:55 2020
...
def createCNN2model(dataType):
    ...
    checkpointPath = dataType+'_CNN2_checkpoint.h5'
    ...
    def fitWithKfold(X,Y):
      ...
      for train_index, test_index in cv.split(X):
          ...
          t_x, val_x, t_y, val_y = train_test_split(xx_train, yy_train, test_size=0.1, random_state = np.random.randint(1,1000, 1)[0])
    ...
    bestModel = tf.keras.models.load_model(dataType+'_CNN2_checkpoint.h5')
